...
namespace LivePersonChat {
	[Register("ErrorResponse", true)]
	public unsafe partial class ErrorResponse : GeneralResponse {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("ErrorResponse");
		...
		[Export ("init")]
		public ErrorResponse () : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected ErrorResponse (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ErrorResponse (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public ErrorResponse (NSDictionary<NSString, NSObject> jsonDict)
