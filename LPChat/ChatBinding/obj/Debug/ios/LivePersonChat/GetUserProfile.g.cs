...
namespace LivePersonChat {
	[Register("GetUserProfile", true)]
	public unsafe partial class GetUserProfile : GeneralResponse {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("GetUserProfile");
		...
		[Export ("init")]
		public GetUserProfile () : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal GetUserProfile (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public GetUserProfile (NSDictionary<NSString, NSObject> jsonDict)
